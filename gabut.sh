...
echo -e  "Tools    : Neffix $white         " |lolcat

echo -e  "Creadby  : Copy+Paste  " |lolcat

echo -e  "Contact  : 0895704147219 $white " |lolcat

echo -e  "Note    : Sorry Kalo Jelek Hehe :) $white    " | lolcat 
...
6) echo "created by : Neffix and Copy Paste wkwk" | lolcat
